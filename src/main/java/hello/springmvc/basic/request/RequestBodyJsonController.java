...
public class RequestBodyJsonController {
  ...
  public String reqeustBodyJsonV3(@RequestBody HelloData data) { // @RequestBody 생략하면 안된다. 생략하면 @ModelAttribute가 들어간다.
    log.info("messageBody={}, age={}", data.getUsername(), data.getAge());
    return "ok";
  }
